...
I build software by taking a problem from **idea → architecture → implementation → testing → deployment**.

- 🔧 **Backend:** Java, Spring Boot, REST APIs, JPA, PostgreSQL
- ☁️ **Cloud & DevOps:** AWS, Linux, Docker, Terraform, Ansible, CI/CD
- 🤖 **AI/ML:** Python, XGBoost, LightGBM, SHAP, MLflow
- 🧠 **Fundamentals:** DSA, Operating Systems, databases and system design

**Looking for:** Software Engineering · Backend · Cloud/DevOps opportunities
...
<img src="https://img.shields.io/badge/XGBoost-189C3D?style=for-the-badge" alt="XGBoost" />
<img src="https://img.shields.io/badge/LightGBM-2F6DB0?style=for-the-badge" alt="LightGBM" />
<img src="https://img.shields.io/badge/SHAP-6A1B9A?style=for-the-badge" alt="SHAP" />
...
**Stack:** XGBoost · LightGBM · SHAP · Fairlearn · FastAPI · React · Redis · PostgreSQL · Docker · MLflow · Prometheus · Grafana · GitHub Actions

**Focus:** AI/ML · Backend · Testing · Observability · Infrastructure
...
**Stack:** AWS VPC · ALB · EC2 · RDS · NAT Gateway · Bastion · Security Groups · Terraform · Ansible

**Focus:** Cloud · Networking · IaC · DevOps
...
**Stack:** Next.js · Node.js/Express · PostgreSQL/Supabase · JWT · REST APIs

**Focus:** Full-Stack · Backend · Database · Authentication
...
**Stack:** React · Vite · JavaScript · D3 · Operating Systems algorithms

**Focus:** CS Fundamentals · Algorithms · Implementation
